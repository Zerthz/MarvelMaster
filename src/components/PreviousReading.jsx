            ...
            <Box sx={{ width: { xs: '90%', lg: '25%' } }} >
                ...
                <Collapse in={expanded} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', }}>
                    <Grid direction="row" container sx={{ alignItems: 'center' }}>
                        ...
                        <Grid item xs={8}>
                            <Link to={"/list/" + supportedLists[id.toLowerCase()].previousReading.name} style={flex}>
                                <img src={supportedLists[id.toLowerCase()].previousReading.url} alt="previous reading" style={imgLink} />
                            </Link>
                        </Grid>
                    </Grid>
                </Collapse>
